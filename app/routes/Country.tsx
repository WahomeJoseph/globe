...
export async function clientLoader({ params }: Route.LoaderArgs) {
  ...
  const results = await fetch(`https://restcountries.com/v3.1/name/${countryName}?fullText=true`);
...
export default function Country({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className=" bg-bgcolor h-screen p-6 grid grid-cols-1 md:grid-cols-2 gap-8">

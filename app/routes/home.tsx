      ...
      <div className="container items-center max-w-6xl mx-auto xl:px-5">
        <div className="flex flex-wrap items-center sm:-mx-3">
          <div className="w-full md:w-1/2 md:px-3">
            <div className="space-y-6 sm:max-w-md lg:max-w-lg">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">
                <span className="block xl:inline">Find More about countries with </span>
              ...
              <div className="flex flex-col sm:flex-row sm:space-x-4">
                ...
                <Link to="/about" className="flex items-center px-6 py-3 shadow-sm shadow-indigo-600 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">
                  Learn More
                </Link>
              </div>
            </div>
          ...
          <div className="w-full md:w-1/2">
            <div className="overflow-hidden rounded-md shadow-md shadow-indigo-600">
